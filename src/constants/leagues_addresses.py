...
# MLBL
MLBL_PLAYER_PROFILE_EXAMPLE_ADDRESS: Final[AnyHttpUrl] = AnyHttpUrl(
...
MLBL_GAME_STATISTIC_ADDRESS: Final[str] = "https://reg.infobasket.su/Widget/GetOnline/{game_id}?format=json&lang=ru"
MLBL_TEAM_LOGO_ADDRESS: Final[str] = "https://reg.infobasket.su/Widget/GetTeamLogo/{team_id}?compId={comp_id}"
...
# ABL
ABL_PLAYER_PROFILE_EXAMPLE_ADDRESS: Final[AnyHttpUrl] = AnyHttpUrl("https://ablforpeople.com/player/76755?seasonId=48")
...
# BCL
BCL_PLAYER_PROFILE_EXAMPLE_ADDRESS: Final[AnyHttpUrl] = AnyHttpUrl(
